                ...
                <motion.div
                  ...
                  {HOW_IT_WORKS_CONTENT.steps.map((step, index) => (
                      <motion.div
                          ...
                          key={index} className='bg-neutral-900 p-6 rounded-xl shadow-lg
                              ...
                              <div className='flex justify-between items-center mt-4'>
                                  <div className='flex -space-x-2'>
                                      {step.users.map((user, index) => (
                                          <img key={index} src={user}  className='h-8 w-8 rounded-full border-2 border-black' />
                                      ))}
                                  </div>
